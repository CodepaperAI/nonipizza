...
const SL = (s: number, l: number): PriceVariant[] => [
  { label: "Small", price: s },
  { label: "Large", price: l },
];
...
export const menuItems: MenuItem[] = [
  ...
  { id: "salad-garden", name: "Garden Salad", category: "salads", image: "/images/salad-garden.svg", variants: SL(8.99, 10.99), description: "Romaine, mixed veg & balsamic." },
  { id: "salad-julienne", name: "Julienne Salad", category: "salads", image: "/images/salad-julienne.svg", variants: SL(9.99, 11.99), description: "Romaine, mixed veg, ham, cheese & ranch." },
  { id: "salad-chicken", name: "Chicken Salad", category: "salads", image: "/images/salad-chicken.svg", variants: SL(10.99, 12.99), description: "Chicken, romaine, mixed veg, turnip, pickle & garlic sauce." },
  { id: "salad-chicken-caesar", name: "Chicken Caesar Salad", category: "salads", image: "/images/salad-chicken-caesar.svg", variants: SL(10.99, 12.99), description: "Chicken, bacon, romaine, croutons, parmesan & caesar." },
  ...
  { id: "party-pizza-4", name: "Party Pizza — 4 Toppings", category: "pizza", group: "Hip Hip Hooray Party Pizza", tags: ['21"×15"', "18 slices", "2 dippings free"], image: "/images/party-pizza.svg", variants: ONE(32.99), description: "Giant 21\"×15\" party pizza, 18 slices — 4 toppings + 2 dippings free." },
  ...
  // ───────────────────────── CHICKEN WINGS ────────────────────────────
  { id: "wings-baked", name: "Deep-Fried Baked Wings", category: "wings", tags: ["9 sauces"], featured: true, image: "/images/wings-baked.svg", description: "Signature wings — 9 sauces: Mild, Medium & Hot, Honey Garlic, BBQ, Sweet Thai, Buffalo, Suicide, Fire & Ice, Blue Cheese.", variants: [{ label: "1 LB", price: 13.99 }, { label: "2 LB", price: 24.99 }, { label: "3 LB", price: 35.99 }, { label: "4 LB", price: 52.99 }] },
  { id: "wings-breaded", name: "Deep-Fried Breaded Wings", category: "wings", tags: ["9 sauces"], image: "/images/wings-breaded.svg", description: "Crispy breaded, tossed in your choice of 9 sauces.", variants: [{ label: "1 LB", price: 13.99 }, { label: "2 LB", price: 24.99 }, { label: "3 LB", price: 35.99 }, { label: "4 LB", price: 52.99 }] },
  ...
  // ───────────────────────── DIPPING SAUCES ───────────────────────────
  { id: "dip-creamy-garlic", name: "Creamy Garlic", category: "dips", image: "/images/dip.svg", variants: ONE(1.49) },
  ...
  // ──────────────────────── KAWARTHA ICE CREAM ────────────────────────
  { id: "ice-cream-1-scoop", name: "Kawartha Ice Cream — 1 Scoop", category: "ice-cream", isNew: true, image: "/images/ice-cream.svg", variants: ONE(2.99), description: "Flavours: Vanilla, Butterscotch Ripple, Rum & Raisin, Cotton Candy, Mango, Pistachio Almond, Salty Caramel, Choc Chip Cookie Dough, Death by Chocolate, Cookies & Cream, Lactose Free Vanilla. Waffle cone +$1.00." },
  { id: "ice-cream-2-scoop", name: "Kawartha Ice Cream — 2 Scoop", category: "ice-cream", isNew: true, image: "/images/ice-cream.svg", variants: ONE(4.99), description: "Two scoops of Kawartha ice cream. Waffle cone +$1.00." },
